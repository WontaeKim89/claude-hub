...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'wizard.refProjectsDesc': { ko: '다른 프로젝트의 Claude 설정을 참고하여 더 정확한 셋팅을 생성합니다.', en: 'Reference other projects\' Claude settings for more accurate configuration.' },
  'wizard.refCount': { ko: '개 프로젝트의 Claude 설정을 참고합니다', en: 'project(s) Claude settings will be referenced' },
  'wizard.confirmMsg': { ko: '위 참고 내용을 종합하여 프로젝트에 맞는 Claude 설정 파일을 AI가 생성합니다.', en: 'AI will generate optimal Claude configuration files based on the references above.' },
